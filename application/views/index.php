...
<html lang="fr">
<head>
<title>Locagest</title>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="Locagest Teplate">
...
<div class="super_container">
	...
	<div class="home_slider_background" style="background-image:url('<?php echo base_url();?>assets/images/slide1.jpg')"></div>
					<div class="home_slider_content_container text-center">
						<div class="home_slider_content">
							<h1 data-animation-in="flipInX" data-animation-out="animate-out fadeOut">Gestion SIMPLE</h1>
						</div>
					</div>
				</div>
				...
				<div class="owl-item home_slider_item">
					<!-- Image by https://unsplash.com/@aahubs -->
	<div class="home_slider_background" style="background-image:url('<?php echo base_url();?>assets/images/slide2.jpg')"></div>
					<div class="home_slider_content_container text-center">
						<div class="home_slider_content">
							<h1 data-animation-in="flipInX" data-animation-out="animate-out fadeOut">gestion TRANSPARENTE</h1>
						</div>
					</div>
				</div>
				...
				<div class="owl-item home_slider_item">
					<!-- Image by https://unsplash.com/@aahubs -->
	<div class="home_slider_background" style="background-image:url('<?php echo base_url();?>assets/images/slide3.jpg')"></div>
					<div class="home_slider_content_container text-center">
						<div class="home_slider_content">
							<h1 data-animation-in="flipInX" data-animation-out="animate-out fadeOut">plus besoin de se deplacer</h1>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="header_container d-flex flex-row align-items-center trans_300">
						...
						<nav class="main_nav">
							<ul class="main_nav_list">
								<li class="main_nav_item"><a href="<?php echo base_url();?>">Accueil</a></li>
								<li class="main_nav_item"><a href="index.php/Login/login">connexion</a></li>
							</ul>
						</nav>
						...
						<div class="phone_home text-center">
							<a href="index.php/Login/inscription"><span>INSCRIVEZ-VOUS</span></a>
						</div>
						<!-- Hamburger -->
			...
			<ul class="menu_list">
				...
				<li class="menu_item">
					<div class="container">
						<div class="row">
							<div class="col">
								<a href="index.php/Login/login">connexion</a>
							</div>
						</div>
					</div>
				</li>
				<li class="menu_item">
					<div class="container">
						<div class="row">
							<div class="col">
								<a href="index.php/Login/inscription">connexion</a>
							</div>
						</div>
					</div>
				</li>
						...
						<div class="search_box_inner">
							...
							<div class="search_box_title text-center">
								<div class="search_box_title_inner">
									<div class="search_box_title_icon d-flex flex-column align-items-center justify-content-center"><img src="<?php echo base_url();?>assets/images/search.png" alt=""></div>
							...
							<!--<div class="search_arrow_box">
								<div class="search_arrow_box_inner">
									...
									<img src="<?php echo base_url();?>assets/images/search_arrow.png" alt="">
								</div>
							</div>-->
								...
								<div class="search_box_container">
									<ul class="dropdown_row clearfix">
										<li class="dropdown_item dropdown_item_5">
											<div class="dropdown_item_title">Villa</div>
										...
										<li class="dropdown_item dropdown_item_5">
											<div class="dropdown_item_title">Chambre-Salon</div>
										...
										<li class="dropdown_item dropdown_item_5">
											<div class="dropdown_item_title">Entrée-Couché</div>
										...
										<li class="dropdown_item dropdown_item_5">
											<div class="dropdown_item_title">Studio</div>
										...
										<li class="dropdown_item">
											<div class="search_button">
												<input value="Rechercher" type="submit" class="search_submit_button">
											</div>
										</li>
									</ul>
								</div>
			...
			<div class="row">
				<div class="col">
					<div class="section_title text-center">
						...
						<span class="section_subtitle">Appreciez nos offres</span>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-4 featured_card_col">
					...
					<div class="featured_card_container">
						<div class="card featured_card trans_300">
							<div class="featured_panel">OPTION</div>
			<img class="card-img-top" src="<?php echo base_url();?>assets/images/featured_1.jpg" alt="https://unsplash.com/@breather">
							<div class="card-body">
								<div class="card-title"><a href="listings_single.html">Gerer avec transparence</a></div>
								<div class="card-text">Sekou doit personnaliser le texte ici pour qu'on valide.</div>
								<div class="rooms">

									<!-- <div class="room">
										<span class="room_title">Bedrooms</span>
										<div class="room_content">
					<div class="room_image"><img src="<?php echo base_url();?>assets/images/bedroom.png" alt=""></div>
									...
									<!-- <div class="room">
										...
										<div class="room_content">
					<div class="room_image"><img src="<?php echo base_url();?>assets/images/shower.png" alt=""></div>
									...
									<!-- <div class="room">
										...
										<div class="room_content">
					<div class="room_image"><img src="<?php echo base_url();?>assets/images/area.png" alt=""></div>
									...
									<!-- <div class="room">
										...
										<div class="room_content">
					<div class="room_image"><img src="<?php echo base_url();?>assets/images/patio.png" alt=""></div>
						...
						<!-- 			<div class="room">
										...
										<div class="room_content">
					<div class="room_image"><img src="<?php echo base_url();?>assets/images/garage.png" alt=""></div>
						...
						<div class="featured_card_box d-flex flex-row align-items-center trans_300">
							<img src="<?php echo base_url();?>assets/images/tag.svg" alt="https://www.flaticon.com/authors/lucy-g">
							<div class="featured_card_box_content">
								<div class="featured_card_price_title">Commander</div>
				...
				<div class="col-lg-4 featured_card_col">
					...
					<div class="featured_card_container">
						<div class="card featured_card trans_300">
							<div class="featured_panel">OPTION</div>
							<img class="card-img-top" src="<?php echo base_url();?>assets/images/featured_2.jpg" alt="https://unsplash.com/@astute">
							<div class="card-body">
								<div class="card-title"><a href="listings_single.html">Votre appli de gestion Immo</a></div>
								<div class="card-text">Sekou prêche ici encore pour mettre en ligne. C'est important</div>
								<div class="rooms">
						...
						<div class="featured_card_box d-flex flex-row align-items-center trans_300">
							...
							<div class="featured_card_box_content">
								<div class="featured_card_price_title">Commander</div>
								<div class="featured_card_price">890,000</div>
							</div>
						</div>
				...
				<div class="col-lg-4 featured_card_col">
					...
					<div class="featured_card_container">
						<div class="card featured_card trans_300">
							<div class="featured_panel">OPTION</div>
		<img class="card-img-top" src="<?php echo base_url();?>assets/images/featured_3.jpg" alt="https://unsplash.com/@marcusneto">
							<div class="card-body">
								<div class="card-title"><a href="listings_single.html">Application immobilière</a></div>
								<div class="card-text">Le père Sekou doit encore nous dire quoi mettre ici.</div>
								<div class="rooms">
						...
						<div class="featured_card_box d-flex flex-row align-items-center trans_300">
							...
							<div class="featured_card_box_content">
								<div class="featured_card_price_title">Commander</div>
								<div class="featured_card_price">630.000</div>
							</div>
						</div>
			...
			<div class="row">
				<div class="col">
					<div class="section_title text-center">
						...
						<span class="section_subtitle">Nos clients parlent de nous</span>
					</div>
				</div>
			</div>
								...
								<div class="testimonials_item text-center">
									...
									<div class="testimonial_user">
										<div class="testimonial_image mx-auto">
											<img src="<?php echo base_url();?>assets/images/bonhomme-michelin.jpg" alt="https://unsplash.com/@remdesigns">
										</div>
	...
	<div class="workflow">
		<div class="container">
			...
			<div class="row workflow_row">
				<div class="workflow_rocket"><img src="<?php echo base_url();?>assets/images/rocket.png" alt=""></div>
					...
					<div class="cities_slider_container">
						<div class="owl-carousel owl-theme cities_slider">
							...
							<div class="owl-item city_item">
								<a href="#">
									<div class="city_image">
										<img src="<?php echo base_url();?>assets/images/city_1.jpg" alt="">
									</div>
									<div class="city_details"><img src="<?php echo base_url();?>assets/images/search.png" alt=""></div>
							...
							<div class="owl-item city_item">
								<a href="#">
									<div class="city_image">
										<img src="<?php echo base_url();?>assets/images/city_2.jpg" alt="">
									</div>
									<div class="city_details"><img src="<?php echo base_url();?>assets/images/search.png" alt=""></div>
							...
							<div class="owl-item city_item">
								<a href="#">
									<div class="city_image">
										<img src="<?php echo base_url();?>assets/images/city_3.jpg" alt="">
									</div>
									<div class="city_details"><img src="<?php echo base_url();?>assets/images/search.png" alt=""></div>
							...
							<div class="owl-item city_item">
								<a href="#">
									<div class="city_image">
										<img src="<?php echo base_url();?>assets/images/city_4.jpg" alt="">
									</div>
									<div class="city_details"><img src="<?php echo base_url();?>assets/images/search.png" alt=""></div>
							...
							<div class="owl-item city_item">
								<a href="#">
									<div class="city_image">
										<img src="<?php echo base_url();?>assets/images/city_5.jpg" alt="">
									</div>
									<div class="city_details"><img src="<?php echo base_url();?>assets/images/search.png" alt=""></div>
							...
							<div class="owl-item city_item">
								<a href="#">
									<div class="city_image">
										<img src="<?php echo base_url();?>assets/images/city_6.jpg" alt="">
									</div>
									<div class="city_details"><img src="<?php echo base_url();?>assets/images/search.png" alt=""></div>
	...
	*/ ?>
	...
	<div class="cta_1">
		<div class="cta_1_background" style="background-image:url(<?php echo base_url();?>assets/images/cta_1.jpg)"></div>
		<div class="container">
			<div class="row">
				<div class="col">
						...
						<div class="weekly_offer">
							<div class="weekly_offer_content d-flex flex-row">
								<div class="weekly_offer_icon d-flex flex-column align-items-center justify-content-center">
									<img src="<?php echo base_url();?>assets/images/prize.svg" alt="">
								</div>
								<div class="weekly_offer_text text-center">weekly offer</div>
							</div>
							<div class="weekly_offer_image" style="background-image:url(<?php echo base_url();?>assets/images/weekly.jpg)"></div>
						</div>
					</a>
				</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 footer_col">
					...
					<ul class="footer_useful_links">
						<li class="useful_links_item"><a href="#">Inscription</a></li>
						<li class="useful_links_item"><a href="index.php/Login/login">Connexion</a></li>
				...
				<!-- Footer Contact Form -->
				<div class="col-lg-3 footer_col">
					<div class="footer_col_title">Envoyez nous un email</div>
					<div class="footer_contact_form_container">
						<form id="footer_contact_form" class="footer_contact_form" action="post">
							...
							<button id="contact_send_btn" type="submit" class="contact_send_btn trans_200" value="Envoyer">send</button>
						</form>
					</div>
				</div>
				...
				<div class="col-lg-3 footer_col">
					...
					<ul class="contact_info_list">
						...
						<li class="contact_info_item d-flex flex-row">
							...
							<div class="contact_info_text"><a href="mailto:contactme@locagest.immo?Subject=Hello" target="_top">contactme@locagest.immo</a></div>
						</li>
						<li class="contact_info_item d-flex flex-row">
							<div><div class="contact_info_icon"><img src="<?php echo base_url();?>assets/images/planet-earth.svg" alt=""></div></div>
							<div class="contact_info_text"><a href="https://colorlib.com">www.locagest.immo</a></div>
						</li>
					</ul>
				</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This WebSite is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">7itmind</a>
