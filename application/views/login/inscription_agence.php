...
<html lang="en">
    ...
    <body>
            ...
            <div class="cls-content">
                <div class="cls-content-lg panel">
                    <div class="panel-body">
                        ...
                        <form action="<?php echo site_url() ?>/login/creerAgence" method="post" class="form-horizontal" id="form-inscription-agence">
                            <div class="row">
                                <div class="col-sm-12 form-horizontal">
                                    <div class="form-group col-md-6">
                                        <input type="text" class="form-control" placeholder="Denomination" name="denom" id="denom" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <input type="text" class="form-control" placeholder="Siège" name="siege" id="siege" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
        ...
        <script src="<?php echo base_url() ?>/assets/Admin/js/inscription-agence.js"></script>
