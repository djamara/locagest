            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo site_url(); ?>/AccueilAdmin/GestLocataire">Locataires</a></li>
                        <li class="active">Modification d'un locataire</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                            ...
                            <div class="panel">
                                ...
                                <div class="tab-content">
                                    <div id="home" class="container tab-pane active"><br>
                                        ...
                                        <form class="form-horizontal" action="<?php echo site_url() ?>/AccueilAdmin/modifierLocataire" id="form-modif-locataire" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="panel">
                                                        ...
                                                        <div class="panel-body" style="<?php if(isset($nom)) echo 'display:block'; else echo 'display:none'; ?>">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <select class="form-control selectpicker" data-live-search="true" data-width="100%" name="sexe">
                                                        ...
                                                        <div class="panel-body">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    ...
                                                                    <input type="hidden" name="typePersonne" value="<?php echo $typePersonne?>">
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="panel">
                                                        ...
                                                        <div class="panel-footer text-right">
                                                            ...
                                                            <a class="btn btn-purple" href="<?php echo site_url(); ?>/AccueilAdmin/GestLocataire"><span class="fa fa-list"> Liste des locataires</span></a>
                                                        </div>
