                            ...
                            <div class="panel">
                                ...
                                <div class="tab-content">
                                    <div id="home" class="container tab-pane active"><br>
                                        ...
                                        <form class="form-horizontal" action="<?php echo site_url() ?>/AccueilAdmin/modifierProprietaire" id="form-modif-proprietaire" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="panel">
                                                        ...
                                                        <div class="panel-footer text-right">
                                                            ...
                                                            <a class="btn btn-purple" href="<?php echo site_url(); ?>/AccueilAdmin/GestProprietaire"><span class="fa fa-list"> Liste des propriétaires</span></a>
                                                        </div>
