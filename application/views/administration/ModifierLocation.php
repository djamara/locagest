        ...
        <div id="content-container">
            <div id="page-head">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?php echo site_url() . '/AccueilAdmin/Gestlocations/' ?>">Locations</a></li>
                    <li class="active">Modification d'une location</li>
                </ol>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <!--End breadcrumb-->
                                                ...
                                                <div class="panel">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" placeholder="Nom de bien" id="nombien" class="form-control" disabled="" value="<?php echo $location[0]['bienLibelle'] ?>" name="nom" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" placeholder="Nom de typebien" id="nomtypebien" class="form-control" disabled="" 
                                                                       value="<?php echo $location[0]['TypeBienLibelle'] ?>" name="nom" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label" for="demo-hor-inputpass">Localisation du bien <span class="text-danger">*</span> </label>
                                                            <div class="col-sm-4">
                                                                <input type="text" placeholder="Localisation du bien" id="localisationbien" class="form-control" disabled="" value="<?php echo $location[0]['bienLocalisation'] ?>" name="nom" required>
                                                            </div>
                                                            <label class="col-sm-3 control-label" for="demo-hor-inputpass">Montant du bien <span class="text-danger">*</span> </label>
                                                            <div class="col-sm-2">
                                                                <input type="text" placeholder="montant de bien" id="montantbien" class="form-control money" disabled="" value="<?php echo $location[0]['loyerHC'] ?>" name="nom" required>
                                                            </div>
                                                        </div>
                                                        <?php //var_dump($locataire); ?>

                                                        <div class="panel-heading">
                                                            <h3 class="panel-title">INFORMATIONS SUR LE LOCATAIRE</h3>
                                                        </div>
                                                        <hr>

                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label" for="demo-hor-inputpass">Nom et Prenom <span class="text-danger">*</span> </label>
                                                            <div class="col-sm-9">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <input type="date" class="form-control" required="" value="<?php echo $location[0]['dateDebutlocation']?>" name="datedebut" id="datedebut">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label">Date de fin location<span class="text-danger">*</span></label>
                                                            <div class="col-sm-3">
                                                                <input type="date" class="form-control" required="" value="<?php echo $location[0]['dateFinLocation']?>" name="datefin" id="datefin">
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-2">
                                                                <input type="text" class="form-control money" required="" value="<?php echo $location[0]['montantAvance']?>" name="montantavance" id="montantavance" onkeyup="setMontantTotal()">
                                                            </div>
                                                            <label class="col-sm-2 control-label">Montant Caution<span class="text-danger">*</span></label>
                                                            <div class="col-sm-2">
                                                                <input type="text" class="form-control money" required="" value="<?php echo $location[0]['montantCaution']?>" name="montantcaution" id="montantcaution" onkeyup="setMontantTotal()">
                                                            </div>
                                                            <label class="col-sm-2 control-label">Montant Annexe<span class="text-danger"></span></label>
                                                            <div class="col-sm-2">
                                                                <input type="text" class="form-control money" required="" value="<?php echo $location[0]['montantAnnexe']?>" name="montantannexe" id="montantannexe" onkeyup="setMontantTotal()">
                                                            </div>
                                                        </div>
                                                        <br>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <input type="text" class="form-control money" required="" value="<?php echo $location[0]['montantTotal']?>" name="totalMontant" id="totalMontant" readonly="">
                                                            </div>
                                                        </div>
                                                        <!--<div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="panel">
                                                    ...
                                                    <div class="panel-footer text-right">
                                                        ...
                                                        <button class="btn btn-success" type="button" name="enregistrer" id="enregistrer" onclick="updateLocation()">Sauvegarder</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div> 
...
<!-- MODAL CONSTITUANT-->
<div id="ModalLocataire" class="modal fade" role="dialog">
    <div class="container">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="text text-center"><strong>CONSTITUANT DE LA SURETE</strong></h4>
            </div>
            <div class="modal-body">
                <fieldset class="text text-center">
                    <div>
                        <table class="table table-bordered table-striped table-responsive" >
                            <tr class="tr-table text-center" style="background-color: rgb(199,115,13); color: white">
                                <td>NOM</td>
                                <td>PRENOM</td>
                                <td>TELEPHONE</td>
                                <td>EMAIL</td>
                            ...
                            <tbody id="listeConstituant">

                            </tbody>
                        </table>
                        <button class="btn btn-primary" style="background-color: rgb(199,115,13)"><strong>ENREGISTRER UNE NOUVELLE PERSONNE</strong></button>
                    </div>
                </fieldset>
            </div>
...
<script>
                                                            ...
                                                            $('#locataireNom').val(<?php echo $location[0]['idPersonne'] ?>);

                                                            var url_Ajax = "<?php echo site_url(); ?>/AccueilAdmin/updateLocation/";

                                                            var idBien = <?php echo $location[0]['idbien'] ?>;
                                                            var idProprioBien = <?php echo $location[0]['Personne_idPersonne'] ?>;
