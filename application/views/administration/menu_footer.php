                        ...
                        <div class="list-group bg-trans">
                            <a href="#" class="list-group-item">
                                <div class="media-left pos-rel">
                                    <img class="img-circle img-xs" src="<?php echo base_url() ?>/assets/Admin/img/profile-photos/2.png" alt="Profile Picture">
                            ...
                            <a href="#" class="list-group-item">
                                <div class="media-left pos-rel">
                                    <img class="img-circle img-xs" src="<?php echo base_url() ?>/assets/Admin/img/profile-photos/7.png" alt="Profile Picture">
                                </div>
                                <div class="media-body">
                            ...
                            <a href="#" class="list-group-item">
                                <div class="media-left pos-rel">
                                    <img class="img-circle img-xs" src="<?php echo base_url() ?>/assets/Admin/img/profile-photos/1.png" alt="Profile Picture">
                            ...
                            <a href="#" class="list-group-item">
                                <div class="media-left pos-rel">
                                    <img class="img-circle img-xs" src="<?php echo base_url() ?>/assets/Admin/img/profile-photos/4.png" alt="Profile Picture">
                                </div>
                                <div class="media-body">
                            ...
                            <a href="#" class="list-group-item">
                                <div class="media-left pos-rel">
                                    <img class="img-circle img-xs" src="<?php echo base_url() ?>/assets/Admin/img/profile-photos/8.png" alt="Profile Picture">
                            ...
                            <a href="#" class="list-group-item">
                                <div class="media-left pos-rel">
                                    <img class="img-circle img-xs" src="<?php echo base_url() ?>/assets/Admin/img/profile-photos/9.png" alt="Profile Picture">
                ...
                <div class="nano-content">
                    ...
                    <div id="mainnav-profile" class="mainnav-profile">
                        ...
                        <div id="profile-nav" class="collapse list-group bg-trans">
                            <a href="<?php echo site_url() ?>/AccueilAdmin/profile" style="<?php if(isset($_SESSION['idAgence'])) echo 'display:block'; else echo 'display:none'; ?>" class="list-group-item">
                                <i class="demo-pli-male icon-lg icon-fw"></i> Voir mon profile
                            </a>
                            <a href="#" class="list-group-item">
                                <i class="demo-pli-gear icon-lg icon-fw"></i> Paramètres
                            </a>
                            <a href="#" class="list-group-item">
                                <i class="demo-pli-information icon-lg icon-fw"></i> Aide
                            </a>
                            <a href="<?php echo site_url() ?>/Login/deconnecterUser" class="list-group-item">
                                <i class="demo-pli-unlock icon-lg icon-fw"></i> Déconnexion
                            </a>
                        </div>
                    </div>
                    ...
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <!--Menu list item-->
                        <li>
                            <a href="<?php echo site_url() ?>/AccueilAdmin/GestProprietaire">
                                <i class="fa fa-user"></i>
                                <span class="menu-title">
                                    Propriétaires
                                </span>
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                ...
                                <li><a href="<?php echo site_url() ?>/AccueilAdmin/GestGroupeBiens">Groupement de biens</a></li>
                                <!-- <li><a href="dashboard-3.html">Dashboard 3</a></li> -->
                            </ul>
                        </li>
                        
                        <li>
                            <a href="<?php echo site_url() ?>/AccueilAdmin/GestLocataire">
                        ...
                        <li>
                            <a href="<?php echo site_url() ?>/AccueilAdmin/Gestlocations">
                                <i class="fa fa-key"></i>
                                <span class="menu-title">
                                    Locations
                                </span>
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                <li>
                                    <a href="<?php echo site_url() ?>/AccueilAdmin/addDepenses">
                                        <i class="fa fa-balance-scale"></i> Ajout dépense
                                    </a>
                                </li>
                            </ul>
                            <ul class="collapse">
                                <li>
                                    <a href="<?php echo site_url() ?>/AccueilAdmin/listDepenses">
                                        <i class="fa fa-bank"></i> Liste des dépenses
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="collapse">
                                <li>
                                    <a href="<?php echo site_url() ?>/AccueilAdmin/listePaiement"><i class="fa fa-cubes"></i> Règlement Loyer
                                    </a>
                                </li>
                            </ul>
<!--                            <ul class="collapse">
                                <li>
                                    <a href="<?php echo site_url() ?>/AccueilAdmin/bilanBiens"><i class="fa fa-area-chart"></i> Calendrier de paie
                                    </a>
                                </li>
                            </ul>-->
                            <ul class="collapse">
                                <li>
                                    <a href="<?php echo site_url() ?>/AccueilAdmin/DetailLocation"><i class="fa fa-money"></i> Detail Loyer
                                    </a>
                                </li>
                            </ul>
                        </li>
...
<!-- Dual Listbox -->
<script src="<?php echo base_url(); ?>/assets/Admin/plugins/dualListbox/jquery.bootstrap-duallistbox.js"></script>

<!--Demo script [ DEMONSTRATION ]-->
<script src="<?php echo base_url() ?>/assets/Admin/js/demo/nifty-demo.min.js"></script>
<!--DataTables Sample [ SAMPLE ]-->
<script src="<?php echo base_url(); ?>/assets/Admin/js/data-tables.js"></script>
...
<!-- Script de traitement pour les différentes pages -->
<script src="<?php echo base_url() ?>/assets/Admin/js/profile.js"></script>
<script src="<?php echo base_url() ?>/assets/Admin/js/locataire.js"></script>
<script src="<?php echo base_url() ?>/assets/Admin/js/proprietaire.js"></script>
<script src="<?php echo base_url() ?>/assets/Admin/js/agent.js"></script>
<script src="<?php echo base_url() ?>/assets/Admin/js/bien.js"></script>
<script src="<?php echo base_url() ?>/assets/Admin/js/groupe-bien.js"></script>
<!--<script src="<?php //echo base_url()    ?>/assets/Admin/js/location.js"></script> -->
<script src="<?php echo base_url() ?>/assets/Admin/js/bilanBien.js"></script>
<script src='<?php echo base_url() ?>assets/paiement.js'></script>
<script src='<?php echo base_url() ?>assets/Admin/js/depenses.js'></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-confirm/3.3.2/jquery-confirm.min.js"></script>

<script type="text/javascript">
    
    var myDropzone = new Dropzone("#my-dropzone", {// Make the whole body a dropzone
        //url: "<?php //echo site_url("AccueilAdmin/imageBien/" . $idBien . "/" . $idTypeBien)             ?>", // Set the url
        //thumbnailWidth: 150,
        //thumbnailHeight: 100,
        parallelUploads: 5,
        acceptedFiles: "image/*",
        ...
        maxFilesize: 10,
        dictFileTooBig: "Taille maximale de fichier dépassée",
        removedfile: function (file) {
            var name = file.name;
            //alert(<?php //echo $idBien          ?>);

            $.ajax({
                type: "post",
                url: "<?php echo site_url("AccueilAdmin/removeFile/") . $idBien; ?>",
                data: {file: name},
                dataType: 'html'
            });
        ...
        init: function () {
            ...
            $.get("<?php echo site_url("AccueilAdmin/listeImage/") . $idBien; ?>",
                    function (data) {
                        //console.log(data);
                        //console.log("<?php echo base_url(); ?>assets/image-bien/"+"<?php echo $idBien; ?>/");
                        //Si tous les fichiers sont présent
                        if (data.length > 0) {
                            $.each(data, function (key, value) {
                                var mockFile = value;
                                me.emit("addedfile", mockFile);
                                me.emit("thumbnail", mockFile,
                                        "<?php echo base_url(); ?>assets/image-bien/" + "<?php echo $idBien; ?>/" + value.name);
