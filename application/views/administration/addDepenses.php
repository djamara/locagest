                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <select class="form-control selectpicker" data-width="100%" name="nombien" id="idbien" onchange="setAdresse($('#idbien option:selected').attr('id'))" >
                                                                        ...
                                                                        <option value="<?php echo $key['idbien'] ?>" id="<?php echo $key['idbien'] ?>">
                                                    ...
                                                    <div class="panel">
                                                        ...
                                                        <div class="panel-body">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <select class="form-control selectpicker" data-live-search="true" data-width="100%" name="typereparation">
                                                                        <?php foreach ($travaux as $key):?>
                                                                            <option value="<?php echo $key['idTypeTravaux']?>"><?php echo $key['LibelleTravaux']?></option>
                                                                        <?php endforeach;?>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" placeholder="Nom de l'intervenant" id="adresse1" class="form-control" name="nomTechnicien" value="<?php //echo $situationGeo          ?>" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-sm-3 control-label" for="demo-hor-inputpass">Contact<span class="text-danger">*</span> </label>
                                                                <div class="col-sm-3">
                                                                    <input type="text" placeholder="telephone" id="adresse1" class="form-control" name="contactTech" value="" required>
                                                                </div>
                                                                <label class="col-sm-1 control-label" for="demo-hor-inputpass">Adresse<span class="text-danger">*</span> </label>
                                                                <div class="col-sm-5">
                                                                    <input type="text" placeholder="ville, commune, quartier, rue" id="adresse1" class="form-control" name="adresseTech" value="<?php //echo $situationGeo          ?>" required>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <input type="date" class="form-control" name="dateRealisation" value="<?php echo date("Y-m-d") ?>">
                                                                </div>
                                                                <label class="col-sm-1 control-label" for="demo-hor-inputemail">Montant<span class="text-danger">*</span> </label>
                                                                <div class="col-sm-5">
                                                                    <input type="text" class="form-control money" placeholder="montant" name="montantrealisation">
                                                                </div>
                                                            </div>
