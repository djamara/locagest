                    ...
                    <form class="form-horizontal" action="<?php echo site_url() ?>/AccueilAdmin/creerBien" id="form-bien" method="post" enctype="multipart/form-data">
                        ...
                        <div class="tab-base">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a data-toggle="tab" href="#tabNbreCopie">NOMBRE DE COPIE </a>
                                </li>
								<li class="">
                            ...
                            <div class="tab-content">
								<div id="tabNbreCopie" class="tab-pane fade active in">
									<div class="row">
										<div class="col-sm-10">
											<div class="panel">
                                ...
                                <div id="tabInfoGene" class="tab-pane fade ">
                        ...
                        <div class="row">
                            <div class="text-center">
                                <button type="submit" class="btn btn-mint" href="<?php echo site_url("AccueilAdmin/AddBiens/"); ?>"><span class="fa fa-plus"></span> copier le bien</button>
