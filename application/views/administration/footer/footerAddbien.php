...
<script src="<?php echo base_url() ?>/assets/Admin/plugins/masked-input/jquery.maskedinput.min.js"></script>

<!--Form validation [ SAMPLE ]-->
<script src="<?php echo base_url() ?>/assets/Admin/js/demo/form-validation.js"></script>
...
<script src="<?php echo base_url(); ?>/assets/Admin/monscript.js"></script>
<!--Dropzone [ OPTIONAL ]-->
...
<!--Alerts [ SAMPLE ]-->
<script src="<?php echo base_url() ?>/assets/Admin/js/demo/ui-alerts.js"></script>
</body>
