            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo site_url(); ?>/AccueilAdmin/GestProprietaire">Propiétaire</a></li>
                        <li class="active">Création d'un propriétaire</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                            ...
                            <div class="panel">
                                ...
                                <div class="tab-content">
                                    <div id="home" class="container tab-pane active"><br>
                                        ...
                                        <form class="form-horizontal" action="<?php echo site_url() ?>/AccueilAdmin/creerProprietaire" id="form-proprietaire" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="panel">
                                                        ...
                                                        <div class="panel-body">
                                                            <div class="form-group">
                                                                <label class="col-sm-3 control-label" for="demo-hor-inputemail">Type de propriétaire</label>
                                                                <div class="col-sm-3">
                                                                    <select class="form-control selectpicker" data-width="100%" name="type-personne-prop" id="type-personne-prop">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="panel" id="panel-form">
                                                        ...
                                                        <!--
                                                            PERSONNE PHYSIQUE
                                                        -->
                                                        <div class="panel-body" id="form-physique-prop">
                                                            <div class="form-group">
                                                        ...
                                                        <!--
                                                            PERSONNE MORALE
                                                        -->
                                                        <div class="panel-body" id="form-morale-prop">
