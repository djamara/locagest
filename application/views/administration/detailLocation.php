            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Detail des locations</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                ...
                <div id="page-content">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Listes des biens en location</h3>
                        </div>
                                    ...
                                    <table id="table-liste-bien" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($bien as $bien): ?>
                                                ...
                                                <tr>
                                                    <td><?php echo $bien['idLocation'] ?></td>
                                                    ...
                                                    <td class="money"><?php echo $bien['montantLoyer'] ?></td>

                                                    <td>
                                                        <a href="<?php echo site_url() . '/AccueilAdmin/bilanBiensDetail/' .$bien['idLocation'] ?>" class="btn btn-success add-tooltip" data-original-title="Voir les détails des paiements" data-toggle="tooltip"><span class="fa fa-eye"></span></a>
                                                      </td>
                                                </tr>
